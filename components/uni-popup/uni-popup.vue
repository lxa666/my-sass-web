<template>
	<view >
		<view  v-show="show" :style="{ top: offsetTop + 'px;bottom:'+offsetBottom + 'px;background-color: rgba(0, 0, 0, '+transparencyNum+');' }" class="uni-mask"  @click="hide" @touchmove.stop.prevent="moveHandle" />
		<view   v-show="show" :class="'uni-popup-' + position + ' ' + 'uni-popup-' + mode" class="uni-popup" :style="{ bottom:offsetBottom + 'px' }">
				{{ msg }}
				<slot />
